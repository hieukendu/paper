...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/final_vs_label_leaders}
  \caption{ViPragSent-Final versus the strongest best-tuned baseline score for each pragmatic label. Three bars remain below their respective label leaders even though the final system leads on the aggregate macro metric.}
  \label{fig:final-label-leaders}
\end{figure}
